...
class ListaToExcel:
    ...
    def datosToExcel(cls,lista):
        try:
            book =openpyxl.load_workbook('/home/Python/proyecto/check/servicio/store/datos.xlsx')
            ...
            book.save(f'/home/Clientes/CheckLists/CHECKPROV_{lista[0]}_{lista[1]}_{lista[2]}.xlsx')
            print('FIN SH RUN') 
